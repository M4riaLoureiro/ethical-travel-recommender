...
In today's travel landscape, there's a growing need for personalized, sustainable travel recommendations. This project implements a RAG-based system that provides contextually relevant and environmentally conscious travel recommendations for Southeast Asian countries. Previous projects have been developed within this context but only for main european cities. Considering that Southeast Asia is one of the most attractive holiday destinations around the world and with a least amount of protective laws, these countries are much more prone to the problematic consequences of mass tourism than european cities. Because of this, the focus of this work was on this area of the globe that might be the most vulnerable to the consequences of climate change and massive tourism.
